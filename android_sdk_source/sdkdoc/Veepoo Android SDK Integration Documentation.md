# Veepoo Android SDK Integration Documentation
...
- [libble-x.x.aar](https://github.com/HBandSDK/Android_Ble_SDK/tree/master/android_sdk_source/jar_base)
- [libcomx-x.x.jar](https://github.com/HBandSDK/Android_Ble_SDK/tree/master/android_sdk_source/jar_base)
- [libdfu-x.x.jar](https://github.com/HBandSDK/Android_Ble_SDK/tree/master/android_sdk_source/jar_base)
- [libfastdfu-x.x.jar](https://github.com/HBandSDK/Android_Ble_SDK/tree/master/android_sdk_source/jar_base)
...
Please refer to the following link for the Veepoo Android SDK API documentation.
...
### 4.  API Calls and Feature Demonstrations

Please refer to the Demo code and the APK.
