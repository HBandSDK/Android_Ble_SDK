 ...
 * Description:
 */
public class TextAlarmActivity extends BaseVPBLETestActivity implements TextAlarmAdapter.OnTextAlarmToggleChangeListener {
    ...
    public void initEvent() {
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            vpBleManager.addTextAlarm(writeResponse, new ITextAlarmDataListener() {
                @Override
    ...
    private TextAlarm2Setting getTextAlarm2Setting() {
        ...
        String content = etAlarmText.getText().toString();
