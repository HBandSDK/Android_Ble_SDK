...
public interface Oprate {
    ...
    String[] oprateStr = new String[]{
            ...
            , START_BLOOD_GLUCOSE, START_BLOOD_GLUCOSE, BLOOD_GLUCOSE_P_READ, BLOOD_GLUCOSE_P_SETTING, FIND_DEVICE, BLE_RENAME, BT_RENAME, BT_CONNECT, BT_CLOSE, HEALTH_REMIND, JL_DEVICE, CONTACT, CY_FIND_PHONE
    };
}