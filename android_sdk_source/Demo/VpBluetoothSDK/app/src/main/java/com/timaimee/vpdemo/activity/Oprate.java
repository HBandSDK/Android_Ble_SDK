...
public interface Oprate {
    ...
    String MAGNETIC_OPEN = "磁疗-打开";
    String MAGNETIC_CLOSE = "磁疗-关闭";
    String NONE = "NONE";
    String[] oprateStr = new String[]{
            ...
            READ_BLOOD_COMPOSITION_CALIBRATION, SETTING_BLOOD_COMPOSITION_CALIBRATION, DETECT_START_BLOOD_COMPONENT, DETECT_STOP_BLOOD_COMPONENT, DETECT_MULTI_ECG_DETECT, WORLD_CLOCK, G08W_HEALTH_ALARM_INTERVAL, G08W_PPG_DATA_CALLBACK, MAGNETIC_OPEN, MAGNETIC_CLOSE
    };
}