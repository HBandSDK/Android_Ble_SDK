...
public interface Oprate {
    ...
    String READ_HEALTH_V2 = "读取健康数据-新版DEMO";
    String OAD = "固件升级";
    String SHOW_SP = "显示sp";
    ...
    String HRV_START_DETECT = "开始HRV测量";
    String HRV_STOP_DETECT = "停止HRV测量";
    ...
    String READ_MANUAL_DATA = "读取手动测量数据";
    String TCM_DIAGNOSIS_START = "开始中医诊断";
    String TCM_DIAGNOSIS_STOP = "结束中医诊断";
    ...
    String GNSS_SOS_SAFETY_PROTECTION = "GNSS&亲情安全守护&SOS";
    String FUN_SWITCH_READ = "健康辅助-读取";
    String FUN_SWITCH_SETTING = "健康辅助-设置";
    String FUN_4G = "4G功能";
    String AUTO_MEASURE = "自动测量";
    String NRF_OTA = "NRF OTA";
    String QIU_GUO_TCM = "秋果中医数据";
    String QX17_DATA_ACQUISITION = "QX17数据采集";
    String QH15_HEALTH_DATA = "QH15健康数据";
    String NONE = "NONE";
