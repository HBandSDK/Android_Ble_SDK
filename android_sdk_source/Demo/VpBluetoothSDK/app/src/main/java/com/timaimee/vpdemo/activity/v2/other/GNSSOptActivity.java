...
public class GNSSOptActivity extends BaseActivity implements IGNSSOptListener, ISafetyProtectionOptListener {
    ...
    public int getLayoutID() {
        ...
        return R.layout.activity_gnss_opt;
    }

    @Override
    public String pageTitle() {
        return "亲情安全守护&amp;GNSS双向&amp;SOS求助";
    }
    ...
    public void initEvent() {
        ...
        vpBleManager.addGnssLocationOptListener(this);
        vpBleManager.addSafetyProtectionOptListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnStartSafetyProtection) {
            vpBleManager.startSafetyProtection(defaultResponse);
        } else if (v.getId() == R.id.btnStartSafetyProtection) {
            vpBleManager.stopSafetyProtection(defaultResponse);
        } else if (v.getId() == R.id.btnStartSafetyProtection) {
